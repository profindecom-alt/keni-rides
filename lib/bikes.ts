...
export interface BikeBase {
  ...
  tank: string;
  /**
   * Engine displacement in cm³ and peak power in metric hp.
   *
   * The human-readable versions live in the translations ("199 cm³" / "199 cc",
   * "20 ch" / "20 hp") because the units are localised. These raw numbers exist
   * so the Motorcycle structured data can publish real QuantitativeValues
   * instead of parsing a translated string.
   */
...
export const BIKE_BASE: BikeBase[] = [
  { slug: 'bmw-gs1200-adventure', name: 'BMW GS 1200 Adventure', short: 'BMW GS 1200', price: 140, priceShort: 160, deposit: 1500, seat: '890 mm', weight: '260 kg', tank: '30 L', displacementCc: 1170, powerHp: 125 },
  { slug: 'yamaha-tenere-700-world-raid', name: 'Yamaha Ténéré 700 World Raid', short: 'Ténéré 700 World Raid', price: 140, priceShort: 150, deposit: 1500, seat: '890 mm', weight: '220 kg', tank: '23 L', displacementCc: 689, powerHp: 73 },
  { slug: 'yamaha-tenere-700', name: 'Yamaha Ténéré 700', short: 'Ténéré 700', price: 120, priceShort: 140, deposit: 1500, seat: '875 mm', weight: '204 kg', tank: '16 L', displacementCc: 689, powerHp: 73 },
  { slug: 'bmw-f800gs-adventure', name: 'BMW F800GS Adventure', short: 'BMW F800GS', price: 120, priceShort: 140, deposit: 2000, seat: '890 mm', weight: '229 kg', tank: '24 L', displacementCc: 798, powerHp: 85 },
  { slug: 'suzuki-dr650', name: 'Suzuki DR650', short: 'DR650', price: 75, priceShort: 90, deposit: 1000, seat: '885 mm', weight: '166 kg', tank: '13 L', displacementCc: 644, powerHp: 46 },
  { slug: 'suzuki-dr400', name: 'Suzuki DR400', short: 'DR400', price: 75, priceShort: 90, deposit: 1000, seat: '935 mm', weight: '145 kg', tank: '10 L', displacementCc: 398, powerHp: 40 },
  { slug: 'honda-crf250', name: 'Honda CRF250', short: 'CRF250', price: 65, priceShort: 75, deposit: 1000, seat: '830 mm', weight: '144 kg', tank: '7.8 L', displacementCc: 250, powerHp: 25 },
  { slug: 'suzuki-dr200', name: 'Suzuki DR200', short: 'DR200', price: 60, priceShort: 70, deposit: 1000, seat: '810 mm', weight: '126 kg', tank: '13 L', displacementCc: 199, powerHp: 20 },
];
